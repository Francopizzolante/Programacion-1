...
#funcion para ingresar tamaño tablero
def funcion_para_ingresar_tamaño_tablero():
...
#funcion para ingresar tamaño tablero
def funcion_para_ingresar_dificultad():
...
cantidad = funcion_para_ingresar_tamaño_tablero()
nivel = funcion_para_ingresar_dificultad()
